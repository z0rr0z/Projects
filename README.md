...
| 9.   | [Прогнозирование оттока клиентов для телекома](Churn%20forecasting/) | Построение модели, которая будет предсказывать, разорвёт ли абонент договор. | Python, SQL, Pandas, Scikit-learn, LightGBM, CatBoost, PyTorch, Matplotlib, Seaborn, Phik, Shap |
